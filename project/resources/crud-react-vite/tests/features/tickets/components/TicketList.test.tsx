...
import TicketList from '../../../../src/features/tickets/components/TicketList.tsx';
...
describe('TicketList', () => {
    ...
    it('displays a list of tickets when authenticated', async () => {
        ...
        expect(mockedNavigate).toHaveBeenCalledWith('/ticket/view/1');

        await userEvent.click(editButtons[1]);
        expect(mockedNavigate).toHaveBeenCalledWith('/ticket/edit/2');
